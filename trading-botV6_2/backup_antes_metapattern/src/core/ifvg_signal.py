...
class IFVGSignalGenerator:
    ...
    def __init__(self, min_confluence: int = 2, trend_filter: bool = True, symbol: str = "XAUUSD.."):
    ...
    def generate_signal(self,
        ...
        if not all([h4_rating, h1_rating, m15_rating]):
            return TradingSignal(
                ...
                symbol=self.symbol if hasattr(self, 'symbol') else "XAUUSD..",
                entry_price=None,
                stop_loss=None,
                take_profit=None,
                confidence=0.0,
        ...
        from ..utils.helpers import pip_size as get_pip_size
        pip_size = get_pip_size(self.symbol) if hasattr(self, 'symbol') else 0.1
